...
import './AdultManageChildAccountPage.css';
import { useNavigate } from 'react-router-dom';
import Cookies from 'js-cookie';
const apiUrl = process.env.REACT_APP_API_URL;
const AdultManageChildAccountPage = () => {
  ...
  return (
    <div className="manageChildAccountPage-homepage">
      <Sidebar 
      ...
      <div className={`manageChildAccountPage-main-content ${isSidebarOpen ? 'manageChildAccountPage-shifted' : 'manageChildAccountPage-full'}`}>
        <Header />
...
export default AdultManageChildAccountPage;
